class FailureCodes {
  ...
  static const int socket = -13;
  static const int facebookCancelled = -15;
...
class FailureMessages {
  ...
  static const String socket = 'يرجي التأكد من توصيل الإنترنت';
  static const String account_exists_with_different_credentials =
      'هذا الميل مستخدم بالفعل بمنصة اخري';
}
